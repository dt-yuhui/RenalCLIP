...
DOWNSTREAM_TASK='survival_RFS'
NUM_CLASSES=1
EXTERNAL_HOSPITALS='厦门,张掖,瑞金,TCIA,external'
...
for seed in "${seeds[@]}"; do
  ...
  exp_name="cnn_one-kidney_3D_${DOWNSTREAM_TASK}_tc_res18_llm2vec-renal-mt-pretrain-v1_xiong-size_seed-${seed}_demo"

  # Set the environment variable
  export CUDA_VISIBLE_DEVICES=${DEVICE_ID}

  # Execute the Python script with the current hyperparameters
  python downstream_main_cox.py \
