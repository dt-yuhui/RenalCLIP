...
for seed in "${seeds[@]}"; do
  ...
  ckpt_name="cnn_one-kidney_3D_${DOWNSTREAM_TASK}_tc_res18_llm2vec-renal-mt-pretrain-v1_xiong-size_seed-${seed}"
  exp_name="cnn_one-kidney_3D_${DOWNSTREAM_TASK}_tc_res18_llm2vec-renal-mt-pretrain-v1_xiong-size_seed-${seed}_test"
  ...
  python downstream_main_img.py \
    ...
    --batch_size 100 \
    --exp_name ${exp_name} --ckpt_name ${ckpt_name} \
